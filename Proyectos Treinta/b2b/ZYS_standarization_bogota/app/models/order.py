...
FIELDS = OrderedDict({
    ...
    "F_CONSEC_AUTO_REG": {"type": int, "output_length": 1, "default": 1},
    "F_IND_CONTACTO": {"type": int, "output_length": 1, "default": 1},
    "F_430_ID_CO": {"type": str, "output_length": 3, "default": "001"},
    "F_430_ID_TIPO_DOCTO": {"type": str, "output_length": 3, "default": "OV "},
    "F_430_CONSEC_DOCTO": {"type": str, "output_length": 8, "default": None},
    ...
    "F_430_IND_BACKORDER": {"type": int, "output_length": 1, "default": 5},
    "F_430_ID_TERCERO_FACT": {"type": str, "output_length": 15, "default": None},
    "F_430_ID_SUCURSAL_FACT": {"type": int, "output_length": 3, "default": None},
    "F_430_ID_TERCERO_REM": {"type": str, "output_length": 15, "default": None},
    "F_430_ID_SUCURSAL_REM": {"type": int, "output_length": 3, "default": None},
    "F_430_ID_TIPO_CLI_FACT": {"type": str, "output_length": 4, "default": "1030"},
    "F_430_ID_CO_FACT": {"type": str, "output_length": 3, "default": "001"},
    "F_430_FECHA_ENTREGA": {"type": int, "output_length": 8, "default": None},
    "F_430_NUM_DIAS_ENTREGA": {"type": int, "output_length": 3, "default": 2},
    "F_430_NUM_DOCTO_REFERENCIA": {"type": str, "output_length": 15, "default": None},
    "F_430_REFERENCIA": {"type": str, "output_length": 10, "default": ""},
    "F_430_ID_CARGUE": {"type": str, "output_length": 10, "default": "ONLINE"},
    ...
    "F_430_ID_COND_PAGO": {"type": str, "output_length": 3, "default": "001"},
    "F_430_IND_IMPRESION": {"type": int, "output_length": 1, "default": 0},
    "F_430_NOTAS": {"type": str, "output_length": 2000, "default": None}, #Aclarar que se envian notas de descuento
    "F_430_ID_CLI_CONTADO": {"type": str, "output_length": 15, "default": ""},
    "F_430_ID_PUNTO_ENVIO": {"type": int, "output_length": 3, "default": 0},
    "F_430_ID_TERCERO_VENDEDOR": {"type": str, "output_length": 15, "default": "666666666"}, #vendedor
    ...
    "F_419_IND_DESCUENTO": {"type": int, "output_length": 1, "default": 0}
    })
NUMBER_PRECISION = 4
...
class TropiOrder(BaseModel):
    ...
    F_430_CONSEC_DOCTO: constr(
        max_length=FIELDS["F_430_CONSEC_DOCTO"]['output_length'])
    ...
    F_430_ID_SUCURSAL_FACT: conint(
        gt=0, lt=pow(10, FIELDS["F_430_ID_SUCURSAL_FACT"]['output_length']))# Variable
    F_430_ID_TERCERO_REM: constr(
        max_length=FIELDS["F_430_ID_TERCERO_REM"]['output_length']) # Variable
    F_430_ID_SUCURSAL_REM: conint(
        gt=0, lt=pow(10, FIELDS["F_430_ID_SUCURSAL_REM"]['output_length'])) # Variable
    ...
    F_430_NUM_DOCTO_REFERENCIA: constr(
        max_length=FIELDS["F_430_NUM_DOCTO_REFERENCIA"]['output_length']) #variable
    F_430_REFERENCIA: constr(
        max_length=FIELDS["F_430_REFERENCIA"]['output_length']) = FIELDS["F_430_REFERENCIA"]["default"]
    ...
    F_430_ID_TERCERO_VENDEDOR: constr(
        max_length=FIELDS["F_430_ID_TERCERO_VENDEDOR"]['output_length']) = FIELDS["F_430_ID_TERCERO_VENDEDOR"]["default"]
