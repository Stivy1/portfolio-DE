...
FIELDS = OrderedDict({
    ...
    "F_431_ID_CO": {"type": str, "output_length": 3, "default": "001"},
    "F_431_ID_TIPO_DOCTO": {"type": str, "output_length": 3, "default": "OV "},
    "F_431_ID_CONSEC_DOCTO": {"type": str, "output_length": 8, "default": None},
    ...
    "F_431_CODIGO_BARRAS": {"type": str, "output_length": 20, "default": ""}, #preguntar
    "F_431_ID_EXT1_DETALLE": {"type": str, "output_length": 20, "default": ""},
    "F_431_ID_EXT2_DETALLE": {"type": str, "output_length": 20, "default": ""},
    "F_431_ID_BODEGA": {"type": str, "output_length": 5, "default": "B01"},
    ...
    "F_431_ID_CO_MOVTO": {"type": str, "output_length": 3, "default": "001"},
    "F_431_ID_UN_MOVTO": {"type": str, "output_length": 20, "default": "075"},
    "F_431_ID_CCOSTO_MOVTO": {"type": str, "output_length": 15, "default": "514"},
    "F_431_ID_PROYECTO": {"type": str, "output_length": 15, "default": ""},
    "F_431_FECHA_ENTREGA": {"type": int, "output_length": 8, "default": None},
    "F_431_NUM_DIAS_ENTREGA": {"type": int, "output_length": 3, "default": 2}, #preguntar
...
class TropiProduct(BaseModel):
    ...
    F_431_ID_CONSEC_DOCTO: constr(
        max_length=FIELDS["F_431_ID_CONSEC_DOCTO"]['output_length'])
    ...
    F_431_NUM_DIAS_ENTREGA: conint(
        gt =0, lt=pow(10, FIELDS["F_431_NUM_DIAS_ENTREGA"]['output_length'])) = FIELDS["F_431_NUM_DIAS_ENTREGA"]["default"]
