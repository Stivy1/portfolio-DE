...
FIELDS = OrderedDict({
    ...
    "F_CIA": {"type": int, "output_length": 3, "default": 10},
    ...
    "F_430_ID_CO": {"type": str, "output_length": 3, "default": None},
    ...
    "F_430_ID_CO_FACT": {"type": str, "output_length": 3, "default": None},
...
class TropiOrder(BaseModel):
    ...
    F_430_ID_CO: constr(
        max_length=FIELDS["F_430_ID_CO"]['output_length']) #Variable
    ...
    F_430_ID_CO_FACT: constr(
        max_length=FIELDS["F_430_ID_CO_FACT"]['output_length'])
