...
import pandas as pd
logger = get_logger('Tropi Orders', "DEBUG")
...
if caracteres >= 38:
    ...
    response_BQ = dataframe_to_BQ(df, "treintaco-sandbox.b2b_tropi.orders_uploaded", logger)
    logger.debug(F"{response_BQ}")
    response_drive = text_to_drive(text, "1_rRKY1UMORVWnakeW1ERKxAMc8dz1310")
