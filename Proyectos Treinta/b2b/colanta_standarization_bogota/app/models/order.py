...
FIELDS = OrderedDict({
    ...
    "F_430_ID_CO": {"type": str, "output_length": 3, "default": "416"},
    ...
    "F_430_ID_CO_FACT": {"type": str, "output_length": 3, "default": "416"},
    "F_430_FECHA_ENTREGA": {"type": int, "output_length": 8, "default": None},
    "F_430_NUM_DIAS_ENTREGA": {"type": int, "output_length": 3, "default": None}, #resta entre fecha documento y fecha entrega
    "F_430_NUM_DOCTO_REFERENCIA": {"type": str, "output_length": 15, "default": ""},
    "F_430_REFERENCIA": {"type": str, "output_length": 10, "default": ""},
    "F_430_ID_CARGUE": {"type": str, "output_length": 10, "default": ""},
    "F_430_ID_MONEDA_DOCTO": {"type": str, "output_length": 3, "default": "COP"},
    "F_430_ID_MONEDA_CONV": {"type": int, "output_length": 3, "default": "COP"},
    "F_430_TASA_CONV": {"type": str, "output_length": 13, "default": "00000001.000"},
    "F_430_ID_MONEDA_LOCAL": {"type": str, "output_length": 3, "default": "COP"},
    "F_430_TASA_LOCAL": {"type": str, "output_length": 13, "default": "00000001.000"},
    "F_430_ID_COND_PAGO": {"type": str, "output_length": 3, "default": "CCO"},
    "F_430_IND_IMPRESION": {"type": int, "output_length": 1, "default": 0},
    "F_430_NOTAS": {"type": str, "output_length": 2000, "default": None}, #Aclarar que se envian notas de descuento #250 caracteres
    "F_430_ID_CLI_CONTADO": {"type": str, "output_length": 15, "default": ""},
    "F_430_ID_PUNTO_ENVIO": {"type": int, "output_length": 3, "default": 0},
    "F_430_ID_TERCERO_VENDEDOR": {"type": str, "output_length": 15, "default": "901409657"}, #vendedor
...
class TropiOrder(BaseModel):
    ...
    F_430_NUM_DIAS_ENTREGA: conint(
        gt=0, lt=pow(10, FIELDS["F_430_NUM_DIAS_ENTREGA"]['output_length'])) #Variable
