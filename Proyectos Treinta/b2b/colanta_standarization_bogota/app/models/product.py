...
FIELDS = OrderedDict({
    ...
    "F_431_ID_ITEM": {"type": int, "output_length": 7, "default": ""},
    "F_431_REFERENCIA_ITEM": {"type": str, "output_length": 50, "default": None}, # Empty string #ajustar
    ...
    "F_431_ID_UN_MOVTO": {"type": str, "output_length": 20, "default": ""},
    ...
    "F_431_NUM_DIAS_ENTREGA": {"type": int, "output_length": 3, "default": None}, #resta documento y fecha entrega
    ...
    "F_431_IND_PRECIO": {"type": int, "output_length": 1, "default": 1}
    })
NUMBER_PRECISION = 4
...
class TropiProduct(BaseModel):
    ...
    F_431_REFERENCIA_ITEM: constr(
        max_length=FIELDS["F_431_ID_ITEM"]['output_length']) 
